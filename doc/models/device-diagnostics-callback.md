...
import com.verizon.thingspace.models.DeviceDiagnosticsCallback;
import java.io.IOException;

DeviceDiagnosticsCallback deviceDiagnosticsCallback = new DeviceDiagnosticsCallback.Builder(
    "TestQAAccount",
    "Diagnostics",
    "https://yourwebsite.com",
    DateTimeHelper.fromRfc8601DateTime("2019-09-07T23:57:53.292Z")
)
.httpHeaders(ApiHelper.deserialize("{\"key1\":\"val1\",\"key2\":\"val2\"}"))
.build();
```
