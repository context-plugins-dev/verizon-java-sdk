...
import com.verizon.thingspace.models.Firmware;

Firmware firmware = new Firmware.Builder()
    .firmwareName("FOTA_Verizon_Model-A_01To02_HF")
    .participantName("0402196254-00001")
    .launchDate(DateTimeHelper.fromRfc8601DateTime("2018-04-01T16:03:00.000Z"))
    .releaseNote("")
    .model("Model-A")
    .make("Verizon")
