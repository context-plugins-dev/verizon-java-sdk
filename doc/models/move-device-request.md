...
import com.verizon.thingspace.models.MoveDeviceRequest;
import java.util.Arrays;

MoveDeviceRequest moveDeviceRequest = new MoveDeviceRequest.Builder(
    "0212345678-00001"
)
.filter(new DeviceFilter.Builder()
        .account("account4")
