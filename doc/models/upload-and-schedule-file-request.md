...
```java
import com.verizon.thingspace.models.UploadAndScheduleFileRequest;

UploadAndScheduleFileRequest uploadAndScheduleFileRequest = new UploadAndScheduleFileRequest.Builder()
