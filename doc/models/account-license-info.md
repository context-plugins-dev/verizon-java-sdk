...
import com.verizon.thingspace.models.AccountLicenseInfo;
import java.util.Arrays;

AccountLicenseInfo accountLicenseInfo = new AccountLicenseInfo.Builder()
    ...
    .deviceList(Arrays.asList(
        new AccountLicenseDeviceListItem.Builder()
        ...
        new AccountLicenseDeviceListItem.Builder()
            ...
            .assignmentTime(DateTimeHelper.fromRfc8601DateTime("2016-11-29T16:03:42.000Z"))
            .build()
    ))
    .build();
```
