...
```java
import com.verizon.thingspace.models.DeviceMismatchListResult;
import com.verizon.thingspace.models.MismatchedDevice;
import java.util.Arrays;

DeviceMismatchListResult deviceMismatchListResult = new DeviceMismatchListResult.Builder()
    .devices(Arrays.asList(
        new MismatchedDevice.Builder()
