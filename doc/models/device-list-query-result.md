...
```java
import com.verizon.thingspace.models.DeviceListQueryItem;
import com.verizon.thingspace.models.DeviceListQueryResult;
import java.util.Arrays;

DeviceListQueryResult deviceListQueryResult = new DeviceListQueryResult.Builder()
    .accountName("0242078698-00001")
    .hasMoreData(true)
    .lastSeenDeviceId(900000000001000L)
    .deviceList(Arrays.asList(
        new DeviceListQueryItem.Builder()
