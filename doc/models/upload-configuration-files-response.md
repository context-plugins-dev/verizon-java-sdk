...
import com.verizon.thingspace.models.UploadConfigurationFilesResponse;

UploadConfigurationFilesResponse uploadConfigurationFilesResponse = new UploadConfigurationFilesResponse.Builder()
    .fileName("hello-world.txt")
    .fileVersion("1.0")
    .launchDate(DateTimeHelper.fromSimpleDate("2020-08-31"))
    .releaseNote("note")
    .model("Model-A")
    .make("Verizon")
