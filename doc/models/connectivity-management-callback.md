...
```java
import com.verizon.thingspace.models.ConnectivityManagementCallback;

ConnectivityManagementCallback connectivityManagementCallback = new ConnectivityManagementCallback.Builder()
