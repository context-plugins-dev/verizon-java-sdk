...
```java
import com.verizon.thingspace.models.CreateIoTApplicationResponse;

CreateIoTApplicationResponse createIoTApplicationResponse = new CreateIoTApplicationResponse.Builder()
    .appName("newarmapp1")
