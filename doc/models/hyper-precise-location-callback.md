...
```java
import com.verizon.thingspace.models.HyperPreciseLocationCallback;

HyperPreciseLocationCallback hyperPreciseLocationCallback = new HyperPreciseLocationCallback.Builder(
    "BullseyeReporting",
