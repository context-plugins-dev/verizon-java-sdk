...
```java
import com.verizon.thingspace.models.HyperPreciseLocationFault;

HyperPreciseLocationFault hyperPreciseLocationFault = new HyperPreciseLocationFault.Builder()
    .code("900906")
