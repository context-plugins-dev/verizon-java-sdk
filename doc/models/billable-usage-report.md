...
```java
import com.verizon.thingspace.models.BillableUsageReport;
import com.verizon.thingspace.models.ServiceUsage;
import java.util.Arrays;

BillableUsageReport billableUsageReport = new BillableUsageReport.Builder()
    .accountName("1223334444-00001")
    .usageForAllAccounts(false)
    .skuName("TS-LOC-COARSE-CellID-Aggr")
    .transactionsAllowed("5000")
    .totalTransactionCount("350")
    .primaryAccount(new ServiceUsage.Builder()
        .accountName("1223334444-00001")
        .transactionsCount("125")
        .build())
    .managedAccounts(Arrays.asList(
