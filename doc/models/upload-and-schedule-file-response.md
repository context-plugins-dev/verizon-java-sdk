...
```java
import com.verizon.thingspace.models.UploadAndScheduleFileResponse;

UploadAndScheduleFileResponse uploadAndScheduleFileResponse = new UploadAndScheduleFileResponse.Builder()
