...
```java
import com.verizon.thingspace.models.CreateIoTApplicationRequest;

CreateIoTApplicationRequest createIoTApplicationRequest = new CreateIoTApplicationRequest.Builder()
    .appName("newarmapp1")
