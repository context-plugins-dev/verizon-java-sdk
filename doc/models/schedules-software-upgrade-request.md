...
```java
import com.verizon.thingspace.models.SchedulesSoftwareUpgradeRequest;

SchedulesSoftwareUpgradeRequest schedulesSoftwareUpgradeRequest = new SchedulesSoftwareUpgradeRequest.Builder()
