...
import com.verizon.thingspace.models.AccountGroupShareCreateTrigger;
...
AccountGroupShareCreateTrigger accountGroupShareCreateTrigger = new AccountGroupShareCreateTrigger.Builder()
    .triggerName("name of the trigger")
    .accountName("0000123456-00001")
    .triggerCategory(TriggerCategoryEnum.PRICEPLANDATAUSAGE)
    .pricePlanTrigger(new AccountGroupShareObject.Builder()
