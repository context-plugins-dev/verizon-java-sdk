...
|  --- | --- | --- | --- | --- | --- |
| `AccountName` | `String` | Optional | The name of a billing account.<br><br>**Constraints**: *Minimum Length*: `3`, *Maximum Length*: `32`, *Pattern*: `^[A-Za-z0-9]{3,32}$` | String getAccountName() | setAccountName(String accountName) |
...
```java
import com.verizon.thingspace.models.SecuritySubscriptionRequest;

SecuritySubscriptionRequest securitySubscriptionRequest = new SecuritySubscriptionRequest.Builder()
