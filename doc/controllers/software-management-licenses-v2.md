...
**200**: A list of license cancellation candidate devices.
...
**200**: Return a created license cancellation device list.
...
**200**: Result of deletion of candidate list of devices to remove.
