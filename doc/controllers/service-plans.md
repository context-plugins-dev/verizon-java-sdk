...
```java
ServicePlansController servicePlansController = client.getServicePlansController();
```
...
servicePlansController.listAccountServicePlansAsync(aname).thenAccept(result -> {
