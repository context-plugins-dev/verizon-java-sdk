...
/**
 * This is a model class for RoadSignPosition type.
 */
public class RoadSignPosition {
    private int lat;
    private int mLong;
    ...
    /**
     * Converts this RoadSignPosition into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RoadSignPosition [" + "lat=" + lat + ", mLong=" + mLong + "]";
    }

    /**
     * Builds a new {@link RoadSignPosition.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RoadSignPosition.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RoadSignPosition}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RoadSignPosition} object using the set fields.
         * @return {@link RoadSignPosition}
         */
        public RoadSignPosition build() {
            return new RoadSignPosition(lat, mLong);
        }
    }
}
