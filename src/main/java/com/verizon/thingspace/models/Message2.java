...
public class Message2 {
    ...
    protected Message2(
            ...
            @JsonProperty("saeInfo") SaeInfoPayload saeInfo) {
    ...
    public static class Builder {
        ...
        public Builder(boolean isPrivate, List<RoadUserTypesEnum> roadUserType,
                List<TriggerConditionEnum> triggerConditions, SaeInfoPayload saeInfo) {
            this.isPrivate = isPrivate;
            this.roadUserType = roadUserType;
            this.triggerConditions = triggerConditions;
            this.saeInfo = saeInfo;
        ...
        public Message2 build() {
            return new Message2(isPrivate, roadUserType, triggerConditions, saeInfo, limits,
