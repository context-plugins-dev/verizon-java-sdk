...
/**
 * This is a model class for GenericPayload type.
 */
public class GenericPayload {
    ...
    /**
     * Converts this GenericPayload into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GenericPayload [" + "messageType=" + messageType + ", messageFormat="
                + messageFormat + ", payload=" + payload + "]";
    }

    /**
     * Builds a new {@link GenericPayload.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GenericPayload.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GenericPayload}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GenericPayload} object using the set fields.
         * @return {@link GenericPayload}
         */
        public GenericPayload build() {
            return new GenericPayload(messageType, messageFormat, payload);
        }
    }
}
