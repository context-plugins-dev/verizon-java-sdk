...
public enum Type9Enum {
    ...
    static {
        LESSTHAN30MPH.value = "lessThan30Mph";

        valueMap.put("lessThan30Mph", LESSTHAN30MPH);
    }
     ...
     */
    @JsonCreator
    public static Type9Enum constructFromString(String toConvert) throws IOException {
        Type9Enum enumValue = fromString(toConvert);
        if (enumValue == null) {
