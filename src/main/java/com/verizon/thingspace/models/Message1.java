...
public class Message1 {
    ...
    protected Message1(
            ...
            @JsonProperty("saeAlert") SaeAlertPayload saeAlert) {
    ...
    public static class Builder {
        ...
        public Builder(boolean isPrivate, List<RoadUserTypesEnum> roadUserType,
                List<TriggerConditionEnum> triggerConditions, SaeAlertPayload saeAlert) {
            this.isPrivate = isPrivate;
            this.roadUserType = roadUserType;
            this.triggerConditions = triggerConditions;
            this.saeAlert = saeAlert;
        ...
        public Message1 build() {
            return new Message1(isPrivate, roadUserType, triggerConditions, saeAlert, limits,
